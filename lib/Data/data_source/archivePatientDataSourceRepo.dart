...
abstract class ArchivePatientDataSourceRepo {
  ...
  Future<ArchivePatientModel> getArchivePatient(String archiveId);

  /// ➕ Create new archive record
  Future<SuccessModel> createArchivePatient(Map<String, dynamic> data);
  ...
  Future<SuccessModel> deleteArchivePatient(String archiveId);
}
