...
class ClinicDataSourceRepoImpl extends ClinicDataSourceRepo {
  ...
  Future<List<ClinicModel?>> getClinics(
    ...
    try {
      ...
      if (fromOnline == true) {
        ...
        return await _fetchOnlineClinics(data);
      }
  ...
  @override
  Future<SuccessModel> addClinic(Map<String, dynamic> data, String key) async {
    try {
