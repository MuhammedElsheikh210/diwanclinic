import 'package:diwanclinic/Presentation/screens/pharmacy/list/pharmacy_view_model.dart';
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return ConfirmBottomSheet(
          title: "هل أنت متأكد من حذف الصيدلي؟",
          message: "لن تتمكن من استعادة البيانات بعد الحذف.",
          confirmText: "حذف",
          cancelText: "إلغاء",
          onConfirm: () => _deletePharmacy(),
        );
      },
    );
  }

  void _deletePharmacy() {
    controller.deletePharmacy(pharmacy);
    Loader.showSuccess("تم حذف الصيدلي بنجاح");
  }
}
