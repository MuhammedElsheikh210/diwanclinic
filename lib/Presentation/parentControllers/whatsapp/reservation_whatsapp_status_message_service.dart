...
🧾 الروشتة والأدوية المصروفة هتتحفظ تلقائيًا على حسابك في تطبيق لينك وعلى ملفك عند الدكتور، عشان تقدر ترجع لها بسهولة في أي وقت حتى لو الروشتة ضاعت منك أو نسيت اسم دواء أخدته قبل كده.
""";
